...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('indicators_indicator', 'universe', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Indicator.limitations'
        db.add_column('indicators_indicator', 'limitations', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Indicator.routine_use'
        db.add_column('indicators_indicator', 'routine_use', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.universe'
        db.delete_column('indicators_indicator', 'universe')

        # Deleting field 'Indicator.limitations'
        db.delete_column('indicators_indicator', 'limitations')

        # Deleting field 'Indicator.routine_use'
        db.delete_column('indicators_indicator', 'routine_use')
