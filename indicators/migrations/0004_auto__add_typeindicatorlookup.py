...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TypeIndicatorLookup'
        db.create_table('indicators_typeindicatorlookup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('key_unit_type', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('indicator_id', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('indicators', ['TypeIndicatorLookup'])


    def backwards(self, orm):
        
        # Deleting model 'TypeIndicatorLookup'
        db.delete_table('indicators_typeindicatorlookup')
    ...
    models = {
        ...
        'indicators.typeindicatorlookup': {
            ...
            'key_unit_type': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'taggit.tag': {
