...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IndicatorList.visible_in_weave'
        db.add_column('indicators_indicatorlist', 'visible_in_weave', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IndicatorList.visible_in_weave'
        db.delete_column('indicators_indicatorlist', 'visible_in_weave')
