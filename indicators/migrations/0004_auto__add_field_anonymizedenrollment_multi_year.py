...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AnonymizedEnrollment.multi_year'
        db.add_column('indicators_anonymizedenrollment', 'multi_year', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AnonymizedEnrollment.multi_year'
        db.delete_column('indicators_anonymizedenrollment', 'multi_year')
    ...
    models = {
        ...
        'indicators.anonymizedenrollment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'multi_year': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'db_index': 'True'}),
