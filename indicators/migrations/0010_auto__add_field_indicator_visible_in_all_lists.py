...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.visible_in_all_lists'
        db.add_column('indicators_indicator', 'visible_in_all_lists', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.visible_in_all_lists'
        db.delete_column('indicators_indicator', 'visible_in_all_lists')
