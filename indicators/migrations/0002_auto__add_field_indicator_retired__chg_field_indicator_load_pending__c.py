...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.retired'
        db.add_column('indicators_indicator', 'retired', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'Indicator.load_pending'
        db.alter_column('indicators_indicator', 'load_pending', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Indicator.visible_in_all_lists'
        db.alter_column('indicators_indicator', 'visible_in_all_lists', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Indicator.published'
        db.alter_column('indicators_indicator', 'published', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'IndicatorList.visible_in_default'
        db.alter_column('indicators_indicatorlist', 'visible_in_default', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'IndicatorList.public'
        db.alter_column('indicators_indicatorlist', 'public', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'IndicatorList.visible_in_weave'
        db.alter_column('indicators_indicatorlist', 'visible_in_weave', self.gf('django.db.models.fields.BooleanField')(blank=True))


    def backwards(self, orm):
        
        # Deleting field 'Indicator.retired'
        db.delete_column('indicators_indicator', 'retired')

        # Changing field 'Indicator.load_pending'
        db.alter_column('indicators_indicator', 'load_pending', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Indicator.visible_in_all_lists'
        db.alter_column('indicators_indicator', 'visible_in_all_lists', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Indicator.published'
        db.alter_column('indicators_indicator', 'published', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'IndicatorList.visible_in_default'
        db.alter_column('indicators_indicatorlist', 'visible_in_default', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'IndicatorList.public'
        db.alter_column('indicators_indicatorlist', 'public', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'IndicatorList.visible_in_weave'
        db.alter_column('indicators_indicatorlist', 'visible_in_weave', self.gf('django.db.models.fields.BooleanField')())
