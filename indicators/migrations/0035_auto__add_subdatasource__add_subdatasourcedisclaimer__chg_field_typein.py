...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubDataSource'
        db.create_table('indicators_subdatasource', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('disclaimer', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['indicators.SubDataSourceDisclaimer'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('indicators', ['SubDataSource'])

        # Adding model 'SubDataSourceDisclaimer'
        db.create_table('indicators_subdatasourcedisclaimer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('disclaimer', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('indicators', ['SubDataSourceDisclaimer'])

        # Adding M2M table for field sub_datasources on 'DataSource'
        db.create_table('indicators_datasource_sub_datasources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('datasource', models.ForeignKey(orm['indicators.datasource'], null=False)),
            ('subdatasource', models.ForeignKey(orm['indicators.subdatasource'], null=False))
        ))
        db.create_unique('indicators_datasource_sub_datasources', ['datasource_id', 'subdatasource_id'])

        # Changing field 'TypeIndicatorLookup.key_unit_type'
        db.alter_column('indicators_typeindicatorlookup', 'key_unit_type', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Deleting model 'SubDataSource'
        db.delete_table('indicators_subdatasource')

        # Deleting model 'SubDataSourceDisclaimer'
        db.delete_table('indicators_subdatasourcedisclaimer')

        # Removing M2M table for field sub_datasources on 'DataSource'
        db.delete_table('indicators_datasource_sub_datasources')

        # Changing field 'TypeIndicatorLookup.key_unit_type'
        db.alter_column('indicators_typeindicatorlookup', 'key_unit_type', self.gf('django.db.models.fields.CharField')(max_length=10))
