...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndicatorApiJson'
        db.create_table('indicators_indicatorapijson', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('api', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicators.IndicatorApi'])),
            ('json_key', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('indicator_data_key', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('indicators', ['IndicatorApiJson'])

        # Adding model 'IndicatorApi'
        db.create_table('indicators_indicatorapi', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('json', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('indicators', ['IndicatorApi'])

        # Adding model 'IndicatorApiParam'
        db.create_table('indicators_indicatorapiparam', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('indicators', ['IndicatorApiParam'])

        # Adding model 'IndicatorApiParamSet'
        db.create_table('indicators_indicatorapiparamset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('api', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicators.IndicatorApi'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('indicators', ['IndicatorApiParamSet'])

        # Adding M2M table for field param on 'IndicatorApiParamSet'
        db.create_table('indicators_indicatorapiparamset_param', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('indicatorapiparamset', models.ForeignKey(orm['indicators.indicatorapiparamset'], null=False)),
            ('indicatorapiparam', models.ForeignKey(orm['indicators.indicatorapiparam'], null=False))
        ))
        db.create_unique('indicators_indicatorapiparamset_param', ['indicatorapiparamset_id', 'indicatorapiparam_id'])

        # Adding field 'Indicator.api'
        db.add_column('indicators_indicator', 'api',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='indicator_api', null=True, to=orm['indicators.IndicatorApi']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'IndicatorApiJson'
        db.delete_table('indicators_indicatorapijson')

        # Deleting model 'IndicatorApi'
        db.delete_table('indicators_indicatorapi')

        # Deleting model 'IndicatorApiParam'
        db.delete_table('indicators_indicatorapiparam')

        # Deleting model 'IndicatorApiParamSet'
        db.delete_table('indicators_indicatorapiparamset')

        # Removing M2M table for field param on 'IndicatorApiParamSet'
        db.delete_table('indicators_indicatorapiparamset_param')

        # Deleting field 'Indicator.api'
        db.delete_column('indicators_indicator', 'api_id')
    ...
    models = {
        ...
        'indicators.indicator': {
            ...
            'api': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'indicator_api'", 'null': 'True', 'to': "orm['indicators.IndicatorApi']"}),
            ...
            'permissions': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'indicator_permission'", 'null': 'True', 'to': "orm['indicators.Permission']"}),
        ...
        'indicators.indicatorapi': {
            'Meta': {'object_name': 'IndicatorApi'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'json': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
        'indicators.indicatorapijson': {
            'Meta': {'object_name': 'IndicatorApiJson'},
            'api': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['indicators.IndicatorApi']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indicator_data_key': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'json_key': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'indicators.indicatorapiparam': {
            'Meta': {'object_name': 'IndicatorApiParam'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'value': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'indicators.indicatorapiparamset': {
            'Meta': {'object_name': 'IndicatorApiParamSet'},
            'api': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['indicators.IndicatorApi']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'param': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['indicators.IndicatorApiParam']", 'symmetrical': 'False'})
        },
