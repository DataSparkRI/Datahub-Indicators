...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('indicators_indicator', 'published', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.published'
        db.delete_column('indicators_indicator', 'published')
