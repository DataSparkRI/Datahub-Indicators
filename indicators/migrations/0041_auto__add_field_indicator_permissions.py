...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.permissions'
        db.add_column('indicators_indicator', 'permissions',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='indicator_permission', null=True, to=orm['indicators.Permission']),
                      keep_default=False)

        # Removing M2M table for field permissions on 'Indicator'
        db.delete_table(db.shorten_name('indicators_indicator_permissions'))


    def backwards(self, orm):
        # Deleting field 'Indicator.permissions'
        db.delete_column('indicators_indicator', 'permissions_id')

        # Adding M2M table for field permissions on 'Indicator'
        m2m_table_name = db.shorten_name('indicators_indicator_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('indicator', models.ForeignKey(orm['indicators.indicator'], null=False)),
            ('permission', models.ForeignKey(orm['indicators.permission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['indicator_id', 'permission_id'])
