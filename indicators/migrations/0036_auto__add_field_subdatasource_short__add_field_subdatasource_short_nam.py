...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubDataSource.short'
        db.add_column('indicators_subdatasource', 'short', self.gf('django.db.models.fields.CharField')(default='test', max_length=11), keep_default=False)

        # Adding field 'SubDataSource.short_name'
        db.add_column('indicators_subdatasource', 'short_name', self.gf('django.db.models.fields.CharField')(default='test', max_length=12), keep_default=False)

        # Adding field 'SubDataSource.url'
        db.add_column('indicators_subdatasource', 'url', self.gf('django.db.models.fields.URLField')(default='test', max_length=200, blank=True), keep_default=False)

        # Adding field 'SubDataSource.icon_file'
        db.add_column('indicators_subdatasource', 'icon_file', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'SubDataSource.description'
        db.add_column('indicators_subdatasource', 'description', self.gf('django.db.models.fields.TextField')(default='test', blank=True), keep_default=False)

        # Deleting field 'SubDataSourceDisclaimer.disclaimer'
        db.delete_column('indicators_subdatasourcedisclaimer', 'disclaimer')

        # Adding field 'SubDataSourceDisclaimer.title'
        db.add_column('indicators_subdatasourcedisclaimer', 'title', self.gf('django.db.models.fields.CharField')(default='test', max_length=100), keep_default=False)

        # Adding field 'SubDataSourceDisclaimer.content'
        db.add_column('indicators_subdatasourcedisclaimer', 'content', self.gf('django.db.models.fields.TextField')(default='test'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubDataSource.short'
        db.delete_column('indicators_subdatasource', 'short')

        # Deleting field 'SubDataSource.short_name'
        db.delete_column('indicators_subdatasource', 'short_name')

        # Deleting field 'SubDataSource.url'
        db.delete_column('indicators_subdatasource', 'url')

        # Deleting field 'SubDataSource.icon_file'
        db.delete_column('indicators_subdatasource', 'icon_file')

        # Deleting field 'SubDataSource.description'
        db.delete_column('indicators_subdatasource', 'description')

        # Adding field 'SubDataSourceDisclaimer.disclaimer'
        db.add_column('indicators_subdatasourcedisclaimer', 'disclaimer', self.gf('django.db.models.fields.TextField')(default='test'), keep_default=False)

        # Deleting field 'SubDataSourceDisclaimer.title'
        db.delete_column('indicators_subdatasourcedisclaimer', 'title')

        # Deleting field 'SubDataSourceDisclaimer.content'
        db.delete_column('indicators_subdatasourcedisclaimer', 'content')
