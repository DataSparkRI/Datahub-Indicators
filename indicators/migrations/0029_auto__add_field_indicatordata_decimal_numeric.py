...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IndicatorData.decimal_numeric'
        db.add_column('indicators_indicatordata', 'decimal_numeric', self.gf('indicators.fields.RoundingDecimalField')(null=True, max_digits=20, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IndicatorData.decimal_numeric'
        db.delete_column('indicators_indicatordata', 'decimal_numeric')
