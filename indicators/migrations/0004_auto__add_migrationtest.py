...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MigrationTest'
        db.create_table('indicators_migrationtest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('test', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('indicators', ['MigrationTest'])


    def backwards(self, orm):
        
        # Deleting model 'MigrationTest'
        db.delete_table('indicators_migrationtest')
    ...
    models = {
        ...
        'indicators.migrationtest': {
            'Meta': {'object_name': 'MigrationTest'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'test': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
        'taggit.tag': {
