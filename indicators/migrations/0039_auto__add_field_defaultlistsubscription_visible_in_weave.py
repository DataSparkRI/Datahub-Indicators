...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DefaultListSubscription.visible_in_weave'
        db.add_column('indicators_defaultlistsubscription', 'visible_in_weave',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DefaultListSubscription.visible_in_weave'
        db.delete_column('indicators_defaultlistsubscription', 'visible_in_weave')
