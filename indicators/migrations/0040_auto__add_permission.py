...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('indicators_permission')
    ...
    models = {
        ...
        'indicators.indicator': {
            ...
            'permissions': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'indicator_permission'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['indicators.Permission']"}),
