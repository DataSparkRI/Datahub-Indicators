...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DefaultIndicatorList.description'
        db.add_column('indicators_defaultindicatorlist', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DefaultIndicatorList.description'
        db.delete_column('indicators_defaultindicatorlist', 'description')
