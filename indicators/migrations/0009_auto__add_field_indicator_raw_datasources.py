...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.raw_datasources'
        db.add_column('indicators_indicator', 'raw_datasources', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.raw_datasources'
        db.delete_column('indicators_indicator', 'raw_datasources')
