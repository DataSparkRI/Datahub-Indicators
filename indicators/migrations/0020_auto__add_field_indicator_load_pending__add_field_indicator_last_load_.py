...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.load_pending'
        db.add_column('indicators_indicator', 'load_pending', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Indicator.last_load_completed'
        db.add_column('indicators_indicator', 'last_load_completed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.load_pending'
        db.delete_column('indicators_indicator', 'load_pending')

        # Deleting field 'Indicator.last_load_completed'
        db.delete_column('indicators_indicator', 'last_load_completed')
    ...
    models = {
        ...
        'indicators.indicator': {
            ...
            'suppresion_threshold': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'indicators.indicatorlist': {
            ...
            'show_in_weave': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
