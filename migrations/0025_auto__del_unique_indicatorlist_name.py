...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'IndicatorList', fields ['name']
        db.delete_unique('indicators_indicatorlist', ['name'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'IndicatorList', fields ['name']
        db.create_unique('indicators_indicatorlist', ['name'])
