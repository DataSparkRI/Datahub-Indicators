...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.years_available_display'
        db.add_column('indicators_indicator', 'years_available_display', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Changing field 'Indicator.years_available'
        db.alter_column('indicators_indicator', 'years_available', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=200))


    def backwards(self, orm):
        
        # Deleting field 'Indicator.years_available_display'
        db.delete_column('indicators_indicator', 'years_available_display')

        # Changing field 'Indicator.years_available'
        db.alter_column('indicators_indicator', 'years_available', self.gf('django.db.models.fields.CharField')(max_length=200))
