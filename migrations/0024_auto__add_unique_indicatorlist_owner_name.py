...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'IndicatorList', fields ['owner', 'name']
        db.create_unique('indicators_indicatorlist', ['owner_id', 'name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'IndicatorList', fields ['owner', 'name']
        db.delete_unique('indicators_indicatorlist', ['owner_id', 'name'])
