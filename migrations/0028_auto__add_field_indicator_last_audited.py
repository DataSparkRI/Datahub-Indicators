...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.last_audited'
        db.add_column('indicators_indicator', 'last_audited', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.last_audited'
        db.delete_column('indicators_indicator', 'last_audited')
