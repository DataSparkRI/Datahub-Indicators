...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Indicator.type'
        db.delete_column('indicators_indicator', 'type')

        # Adding field 'Indicator.notes'
        db.add_column('indicators_indicator', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Indicator.type'
        db.add_column('indicators_indicator', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=9), keep_default=False)

        # Deleting field 'Indicator.notes'
        db.delete_column('indicators_indicator', 'notes')
