...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataSource.short'
        db.alter_column('indicators_datasource', 'short', self.gf('django.db.models.fields.CharField')(max_length=11))


    def backwards(self, orm):
        
        # Changing field 'DataSource.short'
        db.alter_column('indicators_datasource', 'short', self.gf('django.db.models.fields.CharField')(max_length=4))
