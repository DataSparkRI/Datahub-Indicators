...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.universe'
        db.alter_column('indicators_indicator', 'universe', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Indicator.universe'
        db.alter_column('indicators_indicator', 'universe', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
